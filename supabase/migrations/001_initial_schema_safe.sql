...
DROP TABLE IF EXISTS personal_finances CASCADE;
...
CREATE INDEX IF NOT EXISTS idx_personal_finances_user_id ON personal_finances(user_id);
CREATE INDEX IF NOT EXISTS idx_personal_finances_date ON personal_finances(date);
CREATE INDEX IF NOT EXISTS idx_personal_finances_type ON personal_finances(type);
CREATE INDEX IF NOT EXISTS idx_goals_user_id ON goals(user_id);
CREATE INDEX IF NOT EXISTS idx_market_news_published_at ON market_news(published_at DESC);
CREATE INDEX IF NOT EXISTS idx_market_news_topic ON market_news(topic);
...
DROP TRIGGER IF EXISTS update_personal_finances_updated_at ON personal_finances;
